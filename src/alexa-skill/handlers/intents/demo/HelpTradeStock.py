        ...
        <speak>
          <p>
            <amazon:domain name="conversational">
              ...
              <voice name="Salli"><break time="200ms"/>According to WSJ there was a major service outage, but this event is unlikely to change the fundamentals.  Would you like to know more?</voice>
        ...
        <speak>
          <p>
            <amazon:domain name="conversational">
              ...
              <voice name="Matthew"><break time="200ms"/>Yes.</voice>
              ...
              <voice name="Matthew"><break time="200ms"/>Sure.</voice>
              <voice name="Salli"><break time="300ms"/>Are you willing to hold shares in {symbol}?</voice>
              <voice name="Matthew"><break time="300ms"/>Alright.</voice>
              <voice name="Salli"><break time="300ms"/>I can place an Octank Smart Limit Order at 4% lower for 32 days?  While waiting you'll collect $23.52 in daily interest.</voice>
              <voice name="Matthew"><break time="350ms"/>Explain how that works</voice>
